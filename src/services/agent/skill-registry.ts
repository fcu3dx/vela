...
| Gate | 类型 | 示例 |
|------|------|------|
| A | 禁用词 | "命运的齿轮""心猛地一沉""眼神复杂" |
| B | 句式套路 | 连续3+排比、"不是…而是…"模板 |
| C | 心理告知 | "他感到紧张""她意识到事情不对" |
| D | 节奏均匀 | 段段4-6句、长度整齐 |
| E | 对话腔调 | 每句都有"说道/问道"标签 |
| F | 结尾升华 | 章末总结/升华/感慨 |
| G | 解释腔 | "她不知道的是…""之所以…是因为" |
